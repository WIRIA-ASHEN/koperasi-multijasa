  ...
  <div class="row">
    ...
    <main class="col-md-9  col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Cetak Pinjaman</h1>
      </div>
      
      <div class="container mt-2">
        <div class="mt-2">
            <a href="/cetak-pinjaman/{{ $pinjamans->id }}" class="btn btn-danger" target="_blank">CETAK PDF</a>
        </div>
        <h4 class="mt-2 mb-3 text-center">Detail Pinjaman {{ $pinjamans->anggotas->nama }}</h4>
