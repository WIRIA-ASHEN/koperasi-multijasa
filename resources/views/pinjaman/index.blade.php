  ...
  <div class="row">
    ...
    <main class="col-md-9  col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Pinjaman</h1>
      </div>
      
      <a href="/tambah-pinjaman" class="btn btn-success mb-2">Tambah Pinjaman</a>
      <form action="/pinjaman" method="GET" class="mb-3">
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
              ...
              <td>{{ $pinjaman->user->username }} </td>
              <td>
                  <a href="/pinjaman/edit/{{ $pinjaman->id }}" style="color: black;" class="btn btn-sm btn-warning"><i class="bi bi-pencil-square"></i></a> |
                  @if (auth()->user()->role == 'ketua')
                  <a href="/pinjaman-hapus/{{ $pinjaman->id }}" style="color: black;" class="btn btn-sm btn-danger" onclick="return confirm('Anda yakin ingin menghapus?');"><i class="bi bi-trash"></i></a> |
                  @endif
                  <a href="/cetak/pinjaman/{{ $pinjaman->id }}" style="color: black;" class="btn btn-sm btn-primary"><i class="bi bi-printer"></i></a>
              </td>
          </tr>
      @endforeach
        </tbody>
