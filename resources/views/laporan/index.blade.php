  ...
  <div class="row">
    ...
    <main class="col-md-9  col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Laporan Transaksi Simpanan</h1>
      </div>

      <a href="/laporan-simpanan?{{ Request::has('start_date') ? 'start_date=' . Request::get('start_date') . '&' : '' }}{{ Request::has('end_date') ? 'end_date=' . Request::get('end_date') . '&' : '' }}" class="btn btn-success mb-2" target="_blank">Export Excel</a>
