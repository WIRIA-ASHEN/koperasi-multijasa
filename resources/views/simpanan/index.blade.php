...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9  col-lg-10 px-md-4">
      ...
      <a href="/tambah-simpanan" class="btn btn-success mb-2">Tambah simpanan</a>
      <form action="/simpanan" method="GET" class="mb-3">
        <div class="input-group">
            <input type="text" name="search" class="form-control" placeholder="Cari Nama/Jenis Simpanan/NIK">
      ...
      <table class="table table-hover table-bordered">
        <thead>
          <tr>
            ...
            <th scope="col">Besar Simpanan</th>
        ...
        <tbody>
          ...
          @endphp
            ...
            <tr>
                ...
                <td>{{ \Carbon\Carbon::parse($simpanan->tgl_simpanan)->locale('id')->isoFormat('D MMMM YYYY') }}</td>
                <td>Rp. {{ number_format($simpanan->besar_simpanan, 0, '.', '.')}},-</td>
                <td>{{ $simpanan->user->username }}</td>
                <td>
                  <a href="/simpanan/edit/{{ $simpanan->id }}" style="color: black;" class="btn btn-sm btn-warning"><i class="bi bi-pencil-square"></i></a> 
                  @if (auth()->user()->role == 'ketua')
                  |
                  <a href="/simpanan-hapus/{{ $simpanan->id }}" style="color: black;" onclick="return confirm('Anda yakin ingin menghapus?');" class="btn btn-sm btn-danger"><i class="bi bi-trash"></i></a>
                  @endif
                </td>
            </tr>
            @endforeach
