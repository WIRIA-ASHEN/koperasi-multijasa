...
<div class="row">
  ...
  <main class="col-md-9  col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      <h1 class="h2">Tambah Simpanan</h1>
    </div>
    
    <form action="/simpanan-store" method="post">
      {{ csrf_field() }}
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <select class="form-select" id="id_jenis_simpanan" name="id_jenis_simpanan">
          <option value=""></option>
            @foreach ($jenissimpanans as $jenissimpanan)
              <option value="{{ $jenissimpanan->id }}">{{ $jenissimpanan->nama_simpanan }}</option>
            @endforeach
          </select>
      </div>
      <div class="mb-3">
          <label for="tgl_simpanan" class="form-label">Tanggal Simpanan</label>
          <input type="date" class="form-control" name="tgl_simpanan" id="tgl_simpanan" required>
      </div>
      <div class="mb-3">
          <label for="no_telp" class="form-label">Besar Simpanan</label>
          <input type="number" class="form-control" name="besar_simpanan" id="besar_simpanan" required>
      </div>
