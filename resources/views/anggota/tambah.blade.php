    ...
    <main class="col-md-9  col-lg-10 px-md-4">
      ...
      <form action="/anggota-store" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="name" class="form-control" name="tmpt_lahir" id="tempat_lahir" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea name="alamat" class="form-control" name="alamat" id="alamat" cols="10" rows="0"></textarea>
        </div>
        <div class="mb-3">
            <label for="no_telp" class="form-label">No Telepon</label>
            <input type="no_telp" class="form-control" name="no_telp" id="no_telp" required>
        </div>
