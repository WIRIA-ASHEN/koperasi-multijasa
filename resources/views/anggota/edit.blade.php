    ...
    <main class="col-md-9  col-lg-10 px-md-4">
      ...
      <form action="/anggota-update/{{ $anggota->id }}" method="post">
        ...
        <div class="mb-3">
          ...
          <input type="name" class="form-control" id="nama" name="nama" required value="{{ $anggota->nama}}">
            
        </div>
        <div class="mb-3">
            <label for="nama" class="form-label">NIK</label>
            <input type="number" class="form-control" name="nik" id="nik" required value="{{ $anggota->nik}}">
        </div>
        <div class="mb-3">
            <label for="tempat_lahir" class="form-label">Tempat Lahir</label>
            <input type="name" class="form-control" name="tmpt_lahir" id="tmpt_lahir" required value="{{ $anggota->tmpt_lahir}}">
        </div>
        <div class="mb-3">
            <label for="tgl_lahir" class="form-label">Tanggal Lahir</label>
            <input type="date" class="form-control" name="tgl_lahir" id="tgl_lahir" required value="{{ $anggota->tgl_lahir}}">
          </div>
        <div class="mb-3">
          <label for="alamat" class="form-label">Alamat</label>
            <textarea name="alamat" class="form-control" name="alamat" id="alamat" cols="10" rows="0">{{ $anggota->alamat}}</textarea>
        </div>
        <div class="mb-3">
            <label for="no_telp" class="form-label">No Telepon</label>
            <input type="no_telp" class="form-control" name="no_telp" id="no_telp" required value="{{ $anggota->no_telp}}">
          </div>
          
          <input type="hidden" name="id" id="id" value="{{ $anggota->created_at}}">
          <input type="hidden" name="id" id="id" value="{{ $anggota->updated_at}}">
